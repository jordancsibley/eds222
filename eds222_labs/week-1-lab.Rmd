...
rootdir <- "~/Desktop/MEDS//EDS_222/eds222/"
...
source(here(rootdir,"eds222_labs","_common.R"))
...
# allows you to see number of rows/columns, data types for all the variables 
```
...
loans_table %>% 
  ...
  tab_spanner(columns = 2,
              label = "homeownership") %>% 
  tab_stubhead(label = "application type") %>% 
  tab_header(title = "Contingency table for application type and ownership")
...
```{r hist2}
breaks = seq(5, 27.5, 2.5) # from 5 to 27.5 by levels of 2.5 
