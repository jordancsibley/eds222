...
-   This tells us that in 1999, the highway miles per gallon is 35.79 when engine displacement is a small as possible (zero which is impossible)

B1 = -3.76

-   Slope of 1999 line

-   As engine displacement increases 1 unit, highway mpg decreases 3.76 (of 1999 cars)

B2 = 0.344

-   This tells us that for the cars in 2008, the highway miles per gallon is 35.79 + 0.344 when engine displacement is a small as possible (zero which is impossible)

B3 = 0.305

-   This tells us the slope of the 2008 line in relation to the 1999 line. It is 0.305 more positive

-   As engine displacement increases 1 unit, highway mpg decreases -3.4632
...
ggplot(data =mpg, aes(x = displ, y = hwy, color = year)) +
  ...
  geom_abline(slope = coef(mod2)['displ'], 
              ...
              color = 'coral') +
  geom_abline(slope = (coef(mod2)['displ'] + coef(mod2)['year2008']), 
              intercept = (coef(mod2)['(Intercept)'] + coef(mod2)['displ:year2008']), 
              color = "lightblue" ) +
...
In augment, we still have all the original data points, but now we have the points of the fitted line. That is why in our ggplot for the line, our aesthetics use `.fitted`.
